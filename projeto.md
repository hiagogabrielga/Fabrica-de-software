...
| RF-019 | Configurar alertas de preço | Permitir que os usuários configurem alertas para serem notificados quando o preço de um determinado modelo de carro cair dentro de uma faixa desejada. Esses alertas podem ser enviados via e-mail ou notificação dentro do sistema. |
